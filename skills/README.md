...
| [writing-for-agents](meta/writing-for-agents/SKILL.md) | meta | Meta-skill that governs ALL document writing in the Brain. Use whenever creating or editing any Markdown document — status, handoff, ADR, ficha, guia, relatorio, skill, template — or reviewing one for quality. Triggers:… | `meta/writing-for-agents/SKILL.md` |
| [brain-adr](ops/brain-adr/SKILL.md) | ops | How to write an ADR (Architecture Decision Record) for the Brain. Use when recording a new decision, superseding an existing ADR, or citing ADRs across projects. Triggers: "criar ADR", "registrar decisão", "novo ADR", "… | `ops/brain-adr/SKILL.md` |
| [brain-rodada](ops/brain-rodada/SKILL.md) | ops | How to plan and conduct an execution Rodada (round) in the Brain — blocks, mandatory human stops (PARADAs), pre-defined numbered validation criteria and blocking gates, and an immutable final report. Use when planning m… | `ops/brain-rodada/SKILL.md` |
